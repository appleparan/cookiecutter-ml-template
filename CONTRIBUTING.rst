...
Report bugs at https://github.com/appleparan/cookiecutter-ml-template/issues
...
Cookiecutter ML Template could always use more documentation, whether as part of
...
https://github.com/appleparan/cookiecutter-ml-template/issues.
...
Ready to contribute? Here's how to set up `cookiecutter-ml-template` for local
development. Please note this documentation assumes you already have
`virtualenv` and `Git` installed and ready to go.

1. Fork the `cookiecutter-ml-template` repo on GitHub.
...
2. Clone your fork locally:
   ...
   .. code-block:: bash
    ...
    $ git clone git@github.com:YOUR_NAME/cookiecutter-ml-template.git

::

3. Assuming you have virtualenv installed (If you have Python 3.11 this should
...
6. The next step would be to run the test cases. `cookiecutter-ml-template` uses
